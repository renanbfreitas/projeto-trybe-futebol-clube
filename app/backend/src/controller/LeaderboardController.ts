...
class LeaderboardController {
  ...
  static getMatch(arrayMatches: IMatchOutput[], allTeams: TeamModel[]): ILeaderboardOutput[] {
  ...
  static getAwayMatches(arrayMatches: IMatchOutput[], allTeams: TeamModel[]): ILeaderboardOutput[] {
    const matchesPoints = LeaderboardController.arrayMatchesPoints(arrayMatches);
    const result = allTeams.map((team) => {
  ...
  static getMatches(arrayMatches: ISimplifiedMatch[], allTeams: TeamModel[]): ILeaderboardOutput[] {
    const result = allTeams.map((team) => {
  ...
  async getHomePerformances(_req: Request, res: Response) {
    ...
    const result = LeaderboardController.getMatch(arrayFinishedMatches, allTeams);
